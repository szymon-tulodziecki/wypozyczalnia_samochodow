...
const USERS = [
  ...
  { email: 'user1@autorent.pl',  password: 'User1234!',  firstName: 'Piotr',     lastName: 'Wiśniewski', role: 'agent', phone: '+48 602 300 400' },
  { email: 'user2@autorent.pl',  password: 'User1234!',  firstName: 'Katarzyna', lastName: 'Dąbrowska',  role: 'agent', phone: '+48 603 400 500' },
];
